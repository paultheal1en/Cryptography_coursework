...
s = context.wrap_socket(s, server_hostname='cloudsashs.duckdns.org')
s.connect(('cloudsashs.duckdns.org', 2808))
...
sb = context.wrap_socket(sb, server_hostname='cloudsbshs.duckdns.org')
sb.connect(('cloudsbshs.duckdns.org', 2809))
...
class ThreadedServer(object):
    def __init__(self, host, port):
        ...
        context_server.load_cert_chain(
            certfile='./trust-authority.duckdns.org/certificate.crt',
            keyfile='./trust-authority.duckdns.org/ec-private-key.pem')
