...
#endif
extern "C"{
EXPORT void HMAC_SHA3_256(const CryptoPP::byte* key_content, size_t key_length, const CryptoPP::byte* input_content, size_t input_length, char* output_hexmac, size_t output_size);
}
